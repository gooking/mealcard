...
let saveStateKeys = ['sysconfigMap', 'referrer', 'token', 'xtoken', 'shopIds', 'uid', 'mobile', 'selectedCity', 'merchantToken', 'merchantInfo'];
...
const store = createStore({
	state: {
		...
		merchantToken: lifeData.merchantToken ? lifeData.merchantToken : '',
		merchantInfo: lifeData.merchantInfo ? lifeData.merchantInfo : null,
	},
	mutations: {
